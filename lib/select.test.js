...
test('select 1-1 and 1-2',function () {
  expect(doc.select('1-1,1-2')).toEqual([
    {
      ref: '1-1',
      start: 1,
      end: 1
...
test('select 1-1,1-2,2-1',function () {
  expect(doc.select('1-1,1-2,2-1')).toEqual([
    {
      ref: '1-1',
      start: 1,
      end: 1
...
test('select 1-1...1-3',function () {
  expect(doc.select('1-1...1-3')).toEqual([
    {
      ref: '1-1',
      start: 1,
      end: 1
...
test('select 1-3...2-1',function () {
  expect(doc.select('1-3...2-1')).toEqual([
    {
      ref: '1-3',
      start: 3,
      end: 3
